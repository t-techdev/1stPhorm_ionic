...
export class CustomMacrosComponent implements OnInit {
   ...
   */
  public activeMacro: CustomMacro = null;
  ...
  async ngOnInit() {
    const showYouKnowStorage = await this.storageService.get(DID_YOU_KNOW_SHOW_SETTING_KEY);
  ...
  public setDidYouKnow() {
    ...
    this.storageService.set(DID_YOU_KNOW_SHOW_SETTING_KEY, false);
  }
