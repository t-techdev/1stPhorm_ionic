...
@NgModule({
  declarations: [
    ...
    MealTemplateNameComponent, MealTemplateAddConfigurationComponent
  ],
  imports: [
    CommonModule,
    IonicModule,
  ...
  entryComponents: [EditFoodComponent, MealTemplateNameComponent, MealTemplateAddConfigurationComponent, AddFoodComponent]
})
