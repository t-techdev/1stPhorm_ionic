...
import { ActiveLevelTypes, PreferenceMacroCounting, Sex, TransphormationGoalTypes, Transphormer } from '../../interfaces';
...
export class NutritionCalculatorService {
  ...
  public calculateBasicMacros(
    ...
    const nutritionCalculator = new NutritionCalculator(transphormer, transphormer.latest_weight.imperial.value);
